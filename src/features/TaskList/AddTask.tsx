  ...
  if (!adding) {
    return (
      ...
      >
        ...
        <span style={{ fontSize: '16px', fontFamily: 'Exo 2 rev=1' }}>Add task</span>
      </Box>
    )
  } else {
    return (
      <ClickAwayListener onClickAway={() => setAdding(false)}>
        <div
          style={{
            color: '#aaa',
            padding: '8px',
        ...
        >
          <div>
            ...
            <div style={{ padding: '0px' }}>
              <Button variant='contained' size='small' disabled={taskName.length === 0} onClick={addTask}>
                Add Task
              </Button>
              <Button
